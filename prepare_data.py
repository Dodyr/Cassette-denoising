...
min_duration, frame_length, hop_length_frame, hop_length_frame_noise, nb_samples, n_fft, hop_length_fft):
    ...
    librosa.output.write(path_save_sound + 'noisy_voice_long.wav', noisy_voice_long[0, :], sr=sample_rate)
    voice_long = prod_voice.reshape(1, nb_samples * frame_length)
    librosa.output.write(path_save_sound + 'voice_long.wav', voice_long[0, :], sr=sample_rate)
    noise_long = prod_noise.reshape(1, nb_samples * frame_length)
    librosa.output.write(path_save_sound + 'noise_long.wav', noise_long[0, :], sr=sample_rate)
